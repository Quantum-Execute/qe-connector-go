...
| makerRateLimit | float64  | 否 | 要求maker占比超过该值（优先级低于mustcomplete），范围：0-1，默认："0"                                                                                                                                             |
| povLimit | float64  | 否 | 占市场成交量比例限制，优先级低于mustcomplete，范围：0-1，默认："0.8"                                                                                                                                               |
| limitPrice | float64       | 否 | 最高/低允许交易的价格，买的话就是最高价，卖就是最低价，超出范围停止交易，填"-1"不限制，范围：>0，默认："-1"                                                                                                                                |
...
| **POV 算法参数** |
| povMinLimit | float64  | 否 | 占市场成交量比例下限，范围：小于max(POVLimit-0.01,0)，默认："0"                                                                                                                                                |
| **其他参数** |
